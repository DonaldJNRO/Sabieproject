...
window.displayMailChimpStatus = function (data) {
    ...
    if (!data.result || !mcStatus) return;

    // If error, add error class
    if (data.result === 'error') {
        mcStatus.classList.remove('success-message');
        mcStatus.classList.add('error-message');
        mcStatus.innerHTML = data.msg; // Keep the MailChimp error message
        return;
    }

    // Otherwise, add success class and set your  success message
    mcStatus.classList.remove('error-message');
    mcStatus.classList.add('success-message');
    mcStatus.innerHTML = 'Welcome to Sabię! You’ve successfully subscribed to our waitlist. Stay tuned for exclusive updates and be the first to know when we launch our revolutionary real estate platform. Thank you for joining us on this journey to redefine home and community'; // custom message
};
    ...
    * ------------------------------------------------------ */
    ...
    var countdownFunction = setInterval(function() {
        ...
        updateNumber("days", days < 10 ? "0" + days : days);
        updateNumber("hours", hours < 10 ? "0" + hours : hours);
        updateNumber("minutes", minutes < 10 ? "0" + minutes : minutes);
        updateNumber("seconds", seconds < 10 ? "0" + seconds : seconds);
...
// Function to add the fadeIn class to elements in the viewport
...
// Apply the animation class based on viewport on load
...
var mySwiper = new Swiper('.swiper-container', {
  ...
  document.addEventListener("DOMContentLoaded", () => {
    const elementsToAnimate = document.querySelectorAll('.animate-this');
...
// Function to add shuffle animation to elements when they come into view
function animateElements() {
    const items = document.querySelectorAll('.animate-this');
    items.forEach(item => {
        if (isInViewport(item)) {
...
// Trigger shuffle animation on scroll
window.addEventListener('scroll', animateElements);

function toggleAdditionalContent() {
    var content = document.getElementById('additionalContent'); // Ensure you have this ID in your HTML
